    ...
    <q-card class="carAssigned">
      <div class="headAssignedCar">
        ...
        <div class="assignedCarImg">
          <img v-if="rideStatus.ride_class_name === 'comfort'" src="../../../statics/order_icons/comfort_full.svg" alt="">
          <img v-if="rideStatus.ride_class_name === 'business'" src="../../../statics/order_icons/business_full.svg" alt="">
          <img v-if="rideStatus.ride_class_name === 'miniwen'" src="../../../statics/order_icons/miniwen_full.svg" alt="">
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    phone () {
      return this.rideStatus.performer.phone.replace(/[\W\D]/g, '')
    }
  },
  methods: {
    writeDriver () {
